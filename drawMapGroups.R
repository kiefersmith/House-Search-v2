  map <- leaflet() %>% 
    ...
    addAwesomeMarkers(lng = distance$X, lat = distance$Y, popup = paste(distance$Address,distance$`Sold Price`, distance$`Distance From`, sep = "<br/>"), icon = awesomeIcons(icon = 'home', markerColor = 'blue'), group = "Comps")%>%
