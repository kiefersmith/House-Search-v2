#this is now finding distance between two coords.  
getGeoInfo <- function(address) {
    ...
    #assign("citystate",citystate,envir = .GlobalEnv)
    assign("latitude",lat,envir = .GlobalEnv)
    assign("longitude",lng,envir = .GlobalEnv)
}

#maybe use return instead
